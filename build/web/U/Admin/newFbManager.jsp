...
<html>
    ...
    <body>
        <form class="form-horizontal formData" action="add.jsp" method="POST">
            <input name="type" type="hidden" value="forexBureauManager"/>
            ...
            <div class="form-group">
                <label class="control-label">Forex bureau:</label>
                <select class="form-control" name="forexBureau">
                    <%
                        ForexBureau forexBureau = new ForexBureau();
                        for (ForexBureau fb : forexBureau.getAll()) {
                            out.println("<option value='" + fb.getLicenseNo() + "'>" + fb.getName() + "</option>");
                        }
                    %>
                </select>
            </div>

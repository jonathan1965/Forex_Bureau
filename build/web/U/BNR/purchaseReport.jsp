...
<%
    ...
    p1.add(new Chunk("KIGALI - RWANDA / NATIONAL BANK OF RWANDA", new Font(FontFamily.TIMES_ROMAN, 12, Font.ITALIC, BaseColor.BLACK)));
    ...
    Phrase phrase1 = new Phrase(new Chunk("REPORT OF PURCHASING TRANSACTIONS", new Font(FontFamily.TIMES_ROMAN, 16, Font.NORMAL, BaseColor.BLACK)));
    Phrase phrase2 = new Phrase(new Chunk("RWANDA FOREX BUREAU", new Font(FontFamily.TIMES_ROMAN, 14, Font.NORMAL, BaseColor.BLACK)));
    ...
    Paragraph cp9 = new Paragraph("SOURCE OF FUND", new Font(FontFamily.TIMES_ROMAN, 8, Font.BOLD, BaseColor.LIGHT_GRAY));
    cp9.setAlignment(1);
    cell9.addElement(cp9);
    cell9.setBorder(0);
    PdfPCell cell10 = new PdfPCell();
    cell10.setBackgroundColor(new BaseColor(24, 52, 69));
    Paragraph cp10 = new Paragraph("FOREX BUREAU", new Font(FontFamily.TIMES_ROMAN, 8, Font.BOLD, BaseColor.LIGHT_GRAY));
    cp10.setAlignment(1);
    ...
    for (Purchase pur : purchases) {
        ...
        Paragraph id = new Paragraph(pur.getId() + "", new Font(FontFamily.TIMES_ROMAN, 8, Font.NORMAL, BaseColor.BLACK));
        id.setAlignment(1);
        c1.addElement(id);
        c1.setBorder(0);
        PdfPCell c2 = new PdfPCell();
        Paragraph names = new Paragraph(pur.getClient().getNames() + "", new Font(FontFamily.TIMES_ROMAN, 8, Font.NORMAL, BaseColor.BLACK));
        names.setAlignment(1);
        c2.addElement(names);
        c2.setBorder(0);
        PdfPCell c3 = new PdfPCell();
        Paragraph currency = new Paragraph(pur.getExchangeRate().getForeignCurrency().getUnit(), new Font(FontFamily.TIMES_ROMAN, 8, Font.NORMAL, BaseColor.BLACK));
        currency.setAlignment(1);
        c3.addElement(currency);
        c3.setBorder(0);
        PdfPCell c4 = new PdfPCell();
        Paragraph rate = new Paragraph(pur.getExchangeRate().getActualSellingRate() + "", new Font(FontFamily.TIMES_ROMAN, 8, Font.NORMAL, BaseColor.BLACK));
        rate.setAlignment(1);
        c4.addElement(rate);
        c4.setBorder(0);
        PdfPCell c5 = new PdfPCell();
        Paragraph fcAmount = new Paragraph(pur.getFcAmount() + "", new Font(FontFamily.TIMES_ROMAN, 8, Font.NORMAL, BaseColor.BLACK));
        fcAmount.setAlignment(1);
        c5.addElement(fcAmount);
        c5.setBorder(0);
        PdfPCell c6 = new PdfPCell();
        Paragraph lcAmount = new Paragraph(pur.getLcAmount() + "", new Font(FontFamily.TIMES_ROMAN, 8, Font.NORMAL, BaseColor.BLACK));
        lcAmount.setAlignment(1);
        c6.addElement(lcAmount);
        c6.setBorder(0);
        PdfPCell c7 = new PdfPCell();
        Paragraph date = new Paragraph(pur.getTransDate() + "", new Font(FontFamily.TIMES_ROMAN, 8, Font.NORMAL, BaseColor.BLACK));
        date.setAlignment(1);
        c7.addElement(date);
        c7.setBorder(0);
        PdfPCell c8 = new PdfPCell();
        Paragraph purpose = new Paragraph(pur.getPurpose(), new Font(FontFamily.TIMES_ROMAN, 8, Font.NORMAL, BaseColor.BLACK));
        purpose.setAlignment(1);
        c8.addElement(purpose);
        c8.setBorder(0);
        PdfPCell c9 = new PdfPCell();
        Paragraph source = new Paragraph(pur.getSourcesOfFund(), new Font(FontFamily.TIMES_ROMAN, 8, Font.NORMAL, BaseColor.BLACK));
        source.setAlignment(1);
        c9.addElement(source);
        c9.setBorder(0);
        PdfPCell c10 = new PdfPCell();
        Paragraph forexBureau = new Paragraph(teller.getForexBureau().getName(), new Font(FontFamily.TIMES_ROMAN, 8, Font.NORMAL, BaseColor.BLACK));
        forexBureau.setAlignment(1);
        c10.addElement(forexBureau);
        c10.setBorder(0);
